        ...
        <form id="request-service-form">
          <div class="form-group">
            ...
            <select id="service-type" class="form-control" required>
              ...
              <option value="Sender ID Registration">Dedicated Sender ID Registration (GHS 150.00)</option>
              <option value="Dedicated Shortcode">Dedicated Alphanumeric Shortcode (GHS 1,200.00/mo)</option>
