    ...
    <div style="display:grid;grid-template-columns: 1fr 1fr;gap:24px;align-items:start;" class="buy-credits-layout">
      ...
      <div class="panel glass" style="margin:0;padding:28px;">
        ...
        <div id="buy-pane-bank" class="hidden">
          ...
          <!-- WhatsApp Fast Crediting Box -->
          <div style="background: rgba(37, 211, 102, 0.08); border: 1px solid rgba(37, 211, 102, 0.3); border-radius: 12px; padding: 16px; margin-bottom: 20px;">
            <div style="display: flex; align-items: flex-start; gap: 12px; margin-bottom: 12px;">
              <div style="background: #25D366; color: #fff; width: 36px; height: 36px; border-radius: 10px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
              ...
              <div>
                <div style="font-size: 0.92rem; font-weight: 700; color: var(--text-primary); margin-bottom: 4px;">⚡ Fast Account Crediting via WhatsApp</div>
                <div style="font-size: 0.82rem; color: var(--text-muted); line-height: 1.45;">
                  Send your Payment Reference Code and Account Name directly to us on WhatsApp for fast verification.
                </div>
              </div>
            </div>
            <a href="https://wa.me/2348149346429?text=Hello%20BZTel%20Support,%20I%20just%20completed%20a%20bank%20transfer.%20Here%20are%20my%20details:%0A-%20Reference:%20%0A-%20Sender%20Name:" target="_blank" rel="noopener noreferrer" class="btn btn-block" style="background: #25D366; color: #ffffff; border: none; font-weight: 700; font-size: 0.88rem; padding: 10px 16px; border-radius: 8px; text-decoration: none; display: flex; align-items: center; justify-content: center; gap: 8px;">
              <span>Send Reference & Name on WhatsApp</span> &rarr;
            </a>
          </div>
