    ...
    <>
        ...
        <div className="top-bar-container-l">
          <div className="top-bar-info-l">
            ...
            <div className="top-bar-item-l">
              <svg className="top-bar-icon-l" fill="currentColor" viewBox="0 0 24 24" style={{ width: '18px', height: '18px', flexShrink: 0 }}>
              ...
              <div className="top-bar-text-l">
                ...
                <a href="https://wa.me/2348149346429" target="_blank" rel="noopener noreferrer" className="top-bar-value-l">
                  +234 814 934 6429<span className="hide-mobile-text-l"> (WhatsApp Only)</span>
                </a>
              </div>
            </div>
            ...
            {/* Email Item */}
            <div className="top-bar-item-l">
              <svg className="top-bar-icon-l" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5" style={{ width: '18px', height: '18px', flexShrink: 0 }}>
      ...
      <header className={`navbar-l ${isMobileOpen ? 'mobile-open' : ''}`}>
        <div className="logo-l" onClick={() => window.location.href = '/'} style={{ cursor: 'pointer' }}>
          <img src="/bztel-logo.png" alt="BZTel Logo" className="logo-l-icon" style={{ height: '36px', width: 'auto', objectFit: 'contain' }} />
        ...
        >
          <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5" style={{ width: '24px', height: '24px', flexShrink: 0 }}>
            {isMobileOpen ? (
